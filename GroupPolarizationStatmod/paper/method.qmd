...
data sets contained $2N_e$ rows. We recorded $N_e$ in the web app as metadata
along with data about average opinions and opinion shifts for each experimental
condition across the corpus.
