...
\begin{abstract}
  ...
  This creates ceiling effects that mask whether extreme opinions become less extreme.
  We developed a generative model to demonstrate that 95\% of sixty experimental conditions
