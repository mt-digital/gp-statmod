...
\begin{figure}
  \caption{\textbf{Common components of a group polarization experiment.}
  Participants first give their opinion in response to some prompt (A). Afterwards,
  participants deliberate the topic (B). Participants then give their opinion again
  (C). Opinions are implicitly behavioral choices that are most consistent with some
  complex aggregation of brain states and dynamics, and so are theoretically
  continuous (D).}
  \centering
    \includegraphics[width=0.7\textwidth]{Figures/ModelSketchesA-C.pdf}
    \includegraphics[width=0.65\textwidth]{Figures/ModelSketchesD.pdf}
...
rankings in fdr\_vs\_experiment plots to better understand/compare.}}
  \centering
    \includegraphics[width=0.55\textwidth]{Figures/sigval_for_low_fwer.pdf}
