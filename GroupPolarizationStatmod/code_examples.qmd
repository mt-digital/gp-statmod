...
Change directories to go to the `gp-statmod/GroupPolarizationStatmod` directory where this document lives:

```         
cd gp-statmod/GroupPolarizationStatmod
```
...
(1969).**](code_examples_images/clipboard-1443885641.png){width="575"}
...
I again call the function with the defaults specified, for illustration. Remember the `significance_vals` map to _effect-detection thresholds_ ($d^*$) in the paper.
