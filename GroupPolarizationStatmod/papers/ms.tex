...
One complicating factor to this approach is that statistical power, $W$, varies
between treatments. Therefore, simulated data should yield statistically-significant
group polarization with frequency close to $W$ for a given treatment at a given
...
\paragraph{\citet{Abrams1990}} This study is meant to support the presence of the "self-categorization" effect in
...
\paragraph{\citet{Burnstein1973}} First I want to note this study was funded in part by a Guggenheim fellowship (see
...
\paragraph{\citet{Burnstein1975}} In this study, Burnstein and Vinokur ran an experiment to evaluate their theory
...
\paragraph{\citet{Schkade2010}} Friedkin uses three CDQ topics, "Sports", "School", and "Surgery" that use a
...
\paragraph{\citet{Krizan2007}} Uses five CDQ topics ("scenarios") from Kogan and
...
\paragraph{\citet{Moscovici1969}} Moscovici and Zavalloni studied whether group
...
\paragraph{\citet{Myers1970}} Myers and Bishop test whether group polarization occurs
