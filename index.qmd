...
\DeclareMathOperator*{\argmax}{argmax} % Optional: also define argmax
...
You will learn how the code works that simulates measurements of opinion change
...
the problem in @eq-threshold-spec, finding the effect-detection threshold, $d^*$, that achieves a target false positive rate, $\alpha^* = 0.05$. 
